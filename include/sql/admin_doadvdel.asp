...
elseif IsSqlServer then
	sql_admindoadvdel_name_main=			"DELETE FROM " &table_main& " WHERE name LIKE N'%{0}%' AND adminid={1}"
	sql_admindoadvdel_title_main=			"DELETE FROM " &table_main& " WHERE title LIKE N'%{0}%' AND adminid={1}"
	sql_admindoadvdel_article_main=			"DELETE FROM " &table_main& " WHERE article LIKE N'%{0}%' AND adminid={1}"
end if
