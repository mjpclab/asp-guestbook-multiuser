...
<div id="outerborder" class="outerborder">
	...
	<%if PagesCount>1 and ShowTopPageList then show_page_list ipage,PagesCount,"[¡Ù—‘∑÷“≥]",""%>
	<%if ItemsCount>0 and StatusSearch and ShowTopSearchBox then%><!-- #include file="include/template/guest_searchbox.inc" --><%end if%>

	<%
	if ItemsCount=0 then
		Response.Write "<br/><br/><div class=""centertext"">ƒø«∞…–Œﬁ¡Ù—‘£¨«Îµ„ª˜°∞«©–¥¡Ù—‘°±°£</div><br/><br/>"
	else
	...
	<%if PagesCount>1 and ShowBottomPageList then show_page_list ipage,PagesCount,"[¡Ù—‘∑÷“≥]",""%>
