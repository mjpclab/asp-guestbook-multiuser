...
'========安全性设置========
web_ShowIP=lrs("showip")			'留言者IP显示 0:不显示 1:显示前1位 2:显示前2位 3:显示前3位 4:显示前4位
web_AdminShowIP=lrs("adminshowip")	'为管理员显示IP位数
web_AdminShowOriginalIP=lrs("adminshoworiginalip")	'为管理员显示原始IP位数
...
if web_ShowIP<ShowIP then ShowIP=web_ShowIP		'WebMaster设置优先
if web_AdminShowIP<AdminShowIP then AdminShowIP=web_AdminShowIP		'WebMaster设置优先
if web_AdminShowOriginalIP<AdminShowOriginalIP then AdminShowOriginalIP=web_AdminShowOriginalIP		'WebMaster设置优先
...
TableBulletinTitleColor=lrs("tablebulletintitlecolor")	'表格－版主公告标题文字颜色
TableBulletinTitleBGC=lrs("tablebulletintitlebgc")		'表格－版主公告标题文字颜色
TableBulletinTitlePic=lrs("tablebulletintitlepic")		'表格－版主公告标题文字颜色
...
TableReplyColor=lrs("tablereplycolor")		'表格－回复标题文字颜色
TableReplyBGC=lrs("tablereplybgc")			'表格－回复标题背景色
TableReplyPic=lrs("tablereplypic")			'表格－回复标题背景图片
