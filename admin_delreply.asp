...
cn.BeginTrans
	cn.Execute Replace(Replace(sql_admindelreply_delete,"{0}",Request.QueryString("id")),"{1}",Request.QueryString("user")),,1
	cn.Execute Replace(Replace(sql_admindelreply_update,"{0}",Request.QueryString("id")),"{1}",Request.QueryString("user")),,1
cn.CommitTrans
