		...
		<td style="width:100%; background-color:<%=TableContentBGC%>;">
			<form method="post" action="write.asp" onsubmit="return submitcheck(this)" name="form1">
				...
				<div id="divRequired" style="padding:5px;">
					...
					<%if WriteVcodeCount>0 then%>验证码<span style="color:#FF0000">*</span><input type="text" name="ivcode" size="<%=LeaveVcodeWidth%>"/> <img src="show_vcode.asp?user=<%=request("user")%>" onclick="this.src=this.src" /><br/><br/><%end if%>
