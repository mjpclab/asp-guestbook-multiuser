...
function CreateConn(byref tconn,byval tDBType)
	...
	case 10
		...
		tconn.ConnectionString= _
			...
			";Application Name=Shen Guest Book Multi-User - " & InstanceName & _
			""
...
if (web_IPConStatus=0 and IPConStatus=0) or ipaddr="" or lcase(ipaddr)="unknown" then
	isbanip=false
else
...
'=====================
function web_isbanip(byval ipaddr)
if web_IPConStatus=0 or ipaddr="" or lcase(ipaddr)="unknown" then
	web_isbanip=false
else
	ipaddr=iptohex(ipaddr)
	dim cnx,rsx
...
if tUBB=true then str=ubbcode(str,ubblimit)
...
if ShowAdvPageList then
	...
	str_first_page=		"<a		 name=""page_control"" href=""" &filename& "?page=" &first_page_no& param & "&amp;user=" &request("user")& """ style=""float:left;""><img src=""image/icon_page_first.gif"" class=""pageicon"" title=""第" &first_page_no& "页"" /></a>"
	str_largeprev_page=	"<a		 name=""page_control"" href=""" &filename& "?page=" &largeprev_page_no& param & "&amp;user=" &request("user")& """ style=""float:left;""><img src=""image/icon_page_largeprev.gif"" class=""pageicon"" title=""第" &largeprev_page_no& "页"" /></a>"
	str_prev_page=		"<a		 name=""page_control"" href=""" &filename& "?page=" &prev_page_no& param & "&amp;user=" &request("user")& """ style=""float:left;""><img src=""image/icon_page_prev.gif"" class=""pageicon"" title=""第" &prev_page_no& "页"" /></a>"
	
	str_last_page=		"<a		 name=""page_control"" href=""" &filename& "?page=" &last_page_no& param & "&amp;user=" &request("user")& """ style=""float:right;""><img src=""image/icon_page_last.gif"" class=""pageicon"" title=""第" &last_page_no& "页"" /></a>"
	str_largenext_page=	"<a		 name=""page_control"" href=""" &filename& "?page=" &largenext_page_no& param & "&amp;user=" &request("user")& """ style=""float:right;""><img src=""image/icon_page_largenext.gif"" class=""pageicon"" title=""第" &largenext_page_no& "页"" /></a>"
	str_next_page=		"<a		 name=""page_control"" href=""" &filename& "?page=" &next_page_no& param & "&amp;user=" &request("user")& """ style=""float:right;""><img src=""image/icon_page_next.gif"" class=""pageicon"" title=""第" &next_page_no& "页"" /></a>"
...
Response.Write "<table cellpadding=""2"" class=""generalwindow"">" & _
	...
	"<tr style=""height:40px;"">" & _
		...
		for j=start_page to end_page
			if j=CurPage then
				Response.Write "<a name=""pagenum"" class=""pagenum_curr"" href=""" &filename& "?page=" & cstr(j) & "&amp;user=" &request("user") & param & """>[" &cstr(j)& "]</a> "
			else
				Response.Write "<a name=""pagenum"" class=""pagenum_normal"" href=""" &filename& "?page=" & cstr(j) & "&amp;user=" &request("user") & param & """>[" &cstr(j)& "]</a> "
			end if
		next
...
Response.Write "" & _
"<table cellpadding=""0"" style=""width:100%; border-width:0px; border-collapse:collapse; background-color:" &TitleBGC& "; background-image:url(" &TitlePic& ");"">" & _
...
elseif layercount=3 then
	if HomeName<>"" then Response.Write " &gt;&gt; "
	Response.Write "<a href=""index.asp?user=" &request("user")& """ class=""booktitle"">留言本</a>"
