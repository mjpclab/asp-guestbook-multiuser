...
<div id="outerborder" class="outerborder">
	...
	rs.Open Replace(sql_adminipconfig_status,"{0}",adminid),cn,,,1
		...
		<table cellpadding="10">
			...
			<tr>
				<td style="width:50%; vertical-align:top;">
					...
					<%rs.Open Replace(sql_adminipconfig_status1,"{0}",adminid),cn,,,1
				...
				<td style="width:50%; vertical-align:top;">
					...
					<p class="row">选择要删除的IP段：</p>
					<%rs.Open Replace(sql_adminipconfig_status2,"{0}",adminid),cn,,,1
					if rs.EOF=false then
						Response.Write ""
						while rs.EOF=false
							tlistid=rs("listid")
