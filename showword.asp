...
<div id="outerborder" class="outerborder">
	...
	<%if rs.State=1 then rs.Close%>
		...
		<table cellpadding="2" class="generalwindow" style="width:250px;" ID="Table1">
			<tr>
			...
			<td style="width:100%; text-align:center; vertical-align:top; color:<%=TableContentColor%>; background-color:<%=TableContentBGC%>;">
				...
				<tr>
					<td>验证码：</td>
					<td><input type="text" name="ivcode" size="10" autocomplete="off"> <img src="show_vcode.asp?user=<%=request("user")%>" /></td>
				</tr>
				<%end if%>
