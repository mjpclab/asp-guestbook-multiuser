...
<div id="outerborder" class="outerborder">
	...
	<div class="region region-config admin-tools">
		...
		<div class="content">
			<table>
			<tr>
				<td><a href="admin_config.asp?user=<%=ruser%>&amp;page=1">[基本配置]</a></td>
				<td><a href="admin_config.asp?user=<%=ruser%>&amp;page=2">[邮件通知]</a></td>
				<td><a href="admin_config.asp?user=<%=ruser%>&amp;page=4">[界面尺寸]</a></td>
				<td><a href="admin_config.asp?user=<%=ruser%>&amp;page=8">[功能设置]</a></td>
				<td><a href="admin_config.asp?user=<%=ruser%>">[全部参数]</a></td>
			</tr>
			</table>
			...
			%>
				...
				<div class="field">
					...
					<span class="value"><input type="radio" name="status2" value="2" id="status21"<%=cked(StatusWrite)%><%=dised(web_StatusWrite=false)%> /><label for="status21"<%=dised(web_StatusWrite=false)%>>开启</label>　　<input type="radio" name="status2" value="0" id="status22"<%=cked(StatusWrite=false)%><%=dised(web_StatusWrite=false)%> /><label for="status22"<%=dised(web_StatusWrite=false)%>>关闭</label></span>
				</div>
				<div class="field">
				...
				<div class="field">
					...
					<span class="value"><input type="text" size="4" maxlength="1" name="showip" value="<%=ShowIP%>" />位 (可选值：0～<%=web_ShowIP%>)</span>
				</div>
				<div class="field">
					<span class="label">为管理员显示IP前：</span>
					<span class="value"><input type="text" size="4" maxlength="1" name="adminshowip" value="<%=AdminShowIP%>" />位 (可选值：0～<%=web_AdminShowIP%>)</span>
				</div>
				<div class="field">
					<span class="label">为管理员显示原IP前：</span>
					<span class="value"><input type="text" size="4" maxlength="1" name="adminshoworiginalip" value="<%=AdminShowOriginalIP%>" />位 (可选值：0～<%=web_AdminShowOriginalIP%>,使用代理服务器时此项显示原始IP)</span>
				</div>
				<div class="field">
					<span class="label">登录验证码长度：</span>
					<span class="value"><input type="text" size="4" maxlength="2" name="vcodecount" value="<%=VcodeCount%>" />位 (可选值：<%=web_VcodeCount%>～10)</span>
				</div>
				<div class="field">
					<span class="label">留言验证码长度：</span>
					<span class="value"><input type="text" size="4" maxlength="2" name="writevcodecount" value="<%=WriteVcodeCount%>" />位 (可选值：<%=web_WriteVcodeCount%>～10)</span>
				</div>
			<%
			end if
			...
			%>
				...
				<div class="field">
					...
					<span class="value"><input type="text" size="10" maxlength="2" name="leavevcodewidth" value="<%=rs("leavevcodewidth")%>" /> (默认=10,单位:字母宽度)</span>
				</div>
				<div class="field">
					<span class="label">“留言内容”文本宽度：</span>
					<span class="value"><input type="text" size="10" maxlength="3" name="leavecontentwidth" value="<%=rs("leavecontentwidth")%>" /> (默认=50,单位:字母宽度)</span>
				</div>
				<div class="field">
				...
				<div class="field">
					<span class="label">回复、公告编辑框宽度：</span>
