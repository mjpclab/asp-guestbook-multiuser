		...
		<div class="content">
			...
			<div id="tab-switch">
				...
				<div class="field">
					...
					<span class="value"><input type="radio" name="status5" value="1" id="status51"<%=cked(CBool(tstatus AND 16))%><%=dised(web_StatusNeedAudit)%> /><label for="status51">审核</label>　　<input type="radio" name="status5" value="0" id="status52"<%=cked(Not CBool(tstatus AND 16))%><%=dised(web_StatusNeedAudit)%> /><label for="status52">不审核</label></span>
				</div>
				<div class="field">
			...
			<div id="tab-mail">
				...
				<div class="field">
					...
					<span class="value"><input type="checkbox" value="1" name="mailreplyinform" id="mailreplyinform"<%=cked(CBool(web_MailFlag and MailFlag and 2))%><%=dised(Not web_MailReplyInform)%> /><label for="mailreplyinform"<%=dised(Not web_MailReplyInform)%>>启用</label></span>
				</div>
				<div class="field">
